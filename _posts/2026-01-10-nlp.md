...
graph TD
    playing -->|"P(w<sub>t-2</sub> \mid w<sub>t</sub>)"| Connor
    playing -->|"P(w<sub>t-1</sub> \mid w<sub>t</sub>)"| likes
    playing -->|"P(w<sub>t+1</sub> \mid w<sub>t</sub>)"| computer
    playing -->|"P(w<sub>t+2</sub> \mid w<sub>t</sub>)"| games
  </div>
</div>
